...
class ParsingData:
  ...
  def get_or_update_selections(self, age: int, work_days: int):
    ...
    Args:
        age (граница возраста): int, work_days (количество промущенных по болезни рабочих дней): int

    Return:
        is_ok (Корректные ли параметры): bool, message (сообщение об ошибке): str
    '''
